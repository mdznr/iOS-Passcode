...
- (void)setup
{
	...
	[_backgroundMain setImage:[main resizableImageWithCapInsets:UIEdgeInsetsMake(6, 6, 7, 6) resizingMode:UIImageResizingModeTile]];
	...
	[_backgroundQuestion setImage:[question resizableImageWithCapInsets:UIEdgeInsetsMake(4, 4, 4, 4) resizingMode:UIImageResizingModeTile]];
...
- (void)setQuestionText:(NSString *)questionText andAnswerText:(NSString *)answerText
{
	...
	s = [_questionLabel sizeThatFits:CGSizeMake(280, FLT_MAX)];
	[_questionLabel setFrame:CGRectMake(10, 8, 280, s.height)];
	[self addSubview:_questionLabel];
	
	[_backgroundQuestion setFrame:CGRectMake(2, 2, 300, s.height + 12)]; // Height + 16 for top and bottom padding.
	
	[_answerLabel removeFromSuperview];
	[_answerLabel setText:answerText];
	s = [_answerLabel sizeThatFits:CGSizeMake(280, FLT_MAX)];
