...
- (void)viewDidLoad
{
	...
	CGPoint cardCenter = CGPointMake(self.view.center.x, self.view.center.y-14);
	
	UIImageView *cb1 = [[UIImageView alloc] initWithImage:cardBackground];
	[cb1 setFrame:cardRect];
	[cb1 setCenter:cardCenter];
